...
def mostrar_menu():
    print("\nMenú de Opciones:")
    print("1. Generación de Disparadores de Auditoría")
    print("2. Logs")
    print("3. Salir")
...
def generar_pdf(logs, usuario, fecha_inicio, fecha_fin):
    pdf_filename = f'reporte_logs_{usuario}_{fecha_inicio.replace(":", "-").replace(" ", "")}_a_{fecha_fin.replace(":", "-").replace(" ", "_")}.pdf'
...
def opcion2(cursor):
    ...
    log_directory = r"/var/log/mysql"  # Ajustar la ruta al directorio de logs de MySQL
